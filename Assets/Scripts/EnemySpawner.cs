...
{
    public Enemy enemy;
    public Boss boss; // Boss prefabýný buraya ekleyin
    ...
    {
        // Boss'u sahnenin ortasýna yerleþtir
        GameObject newBoss = Instantiate(boss.gameObject, Vector3.zero, Quaternion.identity);
        currentEnemies.Add(newBoss);
        newBoss.GetComponent<Boss>().enemySpawner = this;
    }
